!function(t) {
  ...
  var e = function() {
      function e() {
          var e = this
            ...
            , a = function(n) {
              return t.isNumeric(n) && (n = Math.floor(n)),
            ...
            , g = function() {
              ...
              return e.$elem.find("option").each(function() {
                  var i, a, r, o;
                  i = t(this).val(),
                  i !== l("emptyRatingValue") && (a = t(this).text(),
                  r = t(this).data("html"),
                  r && (a = r),
                  o = t("<a />", {
                      href: "#",
          ...
          this.readonly = function(t) {
              "boolean" == typeof t && l("readOnly") != t && (j(t),
              s("readOnly", t),
  ...
  t.fn.barrating = function(n, i) {
      return this.each(function() {
          var a = new e;
          if (t(this).is("select") || t.error("Sorry, this plugin only works with select fields."),
          a.hasOwnProperty(n)) {
              if (a.init(i, this),
              "show" === n)
                  return a.show(i);
              if (a.$elem.data("barrating"))
                  return a.$widget = t(this).next(".br-widget"),
                  a[n](i)
          } else {
