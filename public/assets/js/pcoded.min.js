"use strict"; $(document).ready(function () {
    ...
    $("#m-search").on("keyup", function () {
        ...
        var h = $(this).val().length; $(".pcoded-inner-navbar > li").each(function () {
    ...
    function b(g) {
        ...
        setTimeout(function () {
            document.getElementsByClassName("rem-msg")[0].innerHTML = "<p class='chat-cont'>hello dear you write</p> <p class='chat-cont'>" + g + "</p>"; $(".rem-msg").removeClass("rem-msg");
    ...
    $(".card-option .reload-card").on("click", function () {
        ...
        setTimeout(function () {
            g.parents(".card").children(".card-loader").remove(); g.parents(".card").removeClass("card-load")
        }, 3000)
    });
    ...
    $(".card-option .full-card").on("click", function () {
        var m = $(this);
        var h = $(m.parents(".card")); h.toggleClass("full-card");
        $(this).children("a").children("span").toggle();
    ...
    var d =
    {
        ...
        HandleSubMenuTrigger: function () {
                            ...
                            f.off("mouseenter mouseleave").off("click").on("click", function () {
                                ...
                                if (h === 0) {
                                    ...
                                    if ($(this).hasClass("pcoded-trigger")) {
                                        ...
                                        $(".pcoded-submenu > li > .pcoded-submenu > li.pcoded-trigger").children(".pcoded-submenu").slideUp();
                                        $(this).closest(".pcoded-submenu").find("li.pcoded-trigger").removeClass("pcoded-trigger"); $(this).addClass("pcoded-trigger");
                                        $(this).children(".pcoded-submenu").slideDown()
                                    }
                                }
                            });
            ...
            switch (a.SubMenuTrigger) {
                case "click": $(".pcoded-navbar .pcoded-hasmenu").removeClass("is-hover");
                    $(".pcoded-inner-navbar .pcoded-submenu > li > .pcoded-submenu > li").on("click", function (h) {
                        h.stopPropagation(); var i = $(this).closest(".pcoded-submenu").length;
                        if (i === 0) {
                            if
                                ($(this).hasClass("pcoded-trigger")) {
                                $(this).removeClass("pcoded-trigger");
                    ...
                    $(".pcoded-submenu > li").on("click", function (h) {
                        ...
                        } else { if ($(this).hasClass("pcoded-trigger")) { $(this).removeClass("pcoded-trigger"); $(this).children(".pcoded-submenu").slideUp() } else { $(".pcoded-hasmenu li.pcoded-trigger").children(".pcoded-submenu").slideUp(); $(this).closest(".pcoded-submenu").find("li.pcoded-trigger").removeClass("pcoded-trigger"); $(this).addClass("pcoded-trigger"); $(this).children(".pcoded-submenu").slideDown() } }
                    }); break
            }
        }, HandleMenuTrigger: function () {
            var g = $(window); var e = g.width();
            if (e >= 992) {
                    ...
                    if ((e >= 768 && $("body").hasClass("layout-6") || (e >= 768 && $("body").hasClass("layout-7")))) {
                        ...
                        f.off("click").off("mouseenter mouseleave").hover(function () {
                            ...
                            if ($(".pcoded-submenu", this).length) {
                                ...
                                var o = p.offset(); var i = o.left;
                                var h = p.width(); var n = $(window).height();
                                var k = $(window).width(); var m = (i + h <= k);
                                if (!m) {
                        ...
                        if ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) {
                            ...
                            f.off("click").off("mouseenter mouseleave").hover(function () {
                                ...
                                if ($(".pcoded-submenu", this).length) {
                                    var p = $(".pcoded-submenu:first", this);
                                    var o = p.offset(); var i = o.left; var h = p.width();
                                    var n = $(window).height(); var k = $(window).width();
                                    var m = (i + h <= k); if (!m) {
                                        var j = $(".sidenav-inner").attr("style");
                                        $(".sidenav-inner").css({
                                            "margin-left": (parseInt(j.slice(12, j.length - 3)) - 80)
            ...
            switch (a.MenuTrigger) {
                case "click": $(".pcoded-navbar").removeClass("is-hover");
        ...
        HandleOffset: function () {
            switch (a.themelayout) {
                case "horizontal": var e = a.SubMenuTrigger;
                    if (e === "hover") {
                        ...
                        $("li.pcoded-hasmenu").on("click", function (k) {
                            k.preventDefault(); if ($(".pcoded-submenu", this).length) {
                                var n = $(".pcoded-submenu:first", this);
                                var m = n.offset();
                                var g = m.left;
                                var f = n.width();
    ...
    $(".pcoded-main-container,.pcoded-header").on("click", function () {
        if (a < 992) {
            if ($(".pcoded-navbar").hasClass("mob-open") == true) {
                $(".pcoded-navbar").removeClass("mob-open"); $("#mobile-collapse,#mobile-collapse1").removeClass("on")
            }
...
$(".pcoded-main-container,.pcoded-header,.pcoded-navbar.theme-horizontal").on("click", function () {
    var a = $(window)[0].innerWidth; if ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) {
        if (a > 992) {
            if ($(".pcoded-navbar").hasClass("mob-open") == true) {
...
var vw = $(window)[0].innerWidth; if (vw < 992) {
...
$(".layout-14 .pcoded-inner-navbar > li.pcoded-hasmenu").on("mouseenter", function () {
    if (vw >= 992) {
        ...
        g.addClass("pcoded-inner-navbar"); g.html(b);
        var i = $(d, this); var c = i.offset();
        var e = c.left; var n = c.top; var m = i.width();
        var f = $(window).height(); var k = $(window).width();
        var h = $(window).scrollTop();
        var a = g.innerHeight(); g.show();
        console.log(h); if (f <= n + a - h) {
            g.addClass("vedge");
        ...
        $(".navbar-popup .pcoded-submenu > li").on("click", function (l) {
            l.stopPropagation(); var o = $(this).closest(".pcoded-submenu").length; if (o === 0) {
                if ($(this).hasClass("pcoded-trigger")) {
                    $(this).removeClass("pcoded-trigger");
                    $(this).children(".pcoded-submenu").slideUp()
                }
...
$(".pcoded-navbar .pcoded-inner-navbar a").each(function () {
    var b = window.location.href.split(/[?#]/)[0]; if (!$("body").hasClass("layout-14")) {
        if (this.href == b && $(this).attr("href") != "") {
            ...
            if ($("body").hasClass("layout-1") || $("body").hasClass("layout-9")) {
                ...
                a = a.replace("sidelink", ""); a = a.replace("active", "");
