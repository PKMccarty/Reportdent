...
class Exportvisitsub implements FromCollection, WithHeadings, WithTitle
{
    private $pickerStart;
    private $pickerEnd;
    ...
    {
        return 'Report รายงานนัดผู้ป่วย โรงพยาบาลชัยภูมิ 2';
    }
    ...
    {
         return [
            ['รายงานจำนวนนัดผู้ป่วย ทันตกรรม โรงพยาบาลชัยภูมิ 2 ระหว่างวันที่'.$this->pickerStart.' ถึง '.$this->pickerEnd],
            ['คลินิก',
