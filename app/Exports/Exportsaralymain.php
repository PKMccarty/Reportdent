...
class Exportsaralymain implements FromCollection, WithHeadings, WithTitle
{
    private $pickerStart;
    private $pickerEnd;
    private $export2;
    ...
    {
        return 'Report รายงานสรุปรายได้ ทันตกรรมโรงพยาบาลชัยภูมิ';
    }
    ...
    public function headings(): array
    {
        ...
        return [
            ['รายงานสรุปรายได้ ทันตกรรมโรงพยาบาลชัยภูมิ ระหว่างวันที่ ' . $this->pickerStart . ' ถึง ' . $this->pickerEnd],
